...
public class BridgeDetection  implements AlgorithmInterface, BridgeDetectionNodeState{
	BridgeDetection(){
	}
...
//construct a vector store the nodes information.
	 ...
	 * */
	public static Bridge detectBridge(BridgeGraph graph) throws Exception{
		if(graph == null){
	...
	public int exec(Bridge br,String fileName) throws Exception {
		...
		BridgeGraph myGraph = new BridgeGraph(edges);
