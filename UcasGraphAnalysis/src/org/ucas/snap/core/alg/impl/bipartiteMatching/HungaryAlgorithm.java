...
/**
 * Bipartite graph matching algorithm on weighted graph or unweighted graph
 *  
 * @author  chenxx
 * @date	
 * @reference 
...
public class HungaryAlgorithm {
     ...
     */
    public HungaryAlgorithm(int n, int m) {
	reset(n, m);
    }
    ...
    public static void main(String[] args) { 
    	HungaryAlgorithm match = new HungaryAlgorithm(3,3);
    	match.setWeight(0, 0, Double.NEGATIVE_INFINITY);
    	match.setWeight(0, 2, Double.NEGATIVE_INFINITY);
    	match.setWeight(1, 0, Double.NEGATIVE_INFINITY);
    	match.setWeight(2, 0, Double.NEGATIVE_INFINITY);
    	match.setWeight(2, 1, Double.NEGATIVE_INFINITY);
    	System.out.println(Arrays.toString(match.getMatching()));
    }
}
