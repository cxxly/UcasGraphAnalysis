...
public class Graph implements GraphInterface{
	private GraphType type =GraphType. UNDirectedGraph;
	private int[][] adjMatrix;//邻接矩阵
	//private Vector<Vector<Integer>> adjList = new Vector<Vector<Integer>>();//邻接表
	//private Vector<Vector<Integer>>adjMatrix = new  Vector<Vector<Integer>>();
	private HashMap<Integer,Vector<Integer>>adjList = new HashMap<Integer,Vector<Integer>>();
	...
	public Graph(int[][] adjMatrix) throws Exception{
